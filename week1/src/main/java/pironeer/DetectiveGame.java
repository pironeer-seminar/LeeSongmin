...
public class DetectiveGame {
    ...
    private enum AttributeType {
        ...
        public static AttributeType getRandomType() {
    ...
    public void showIntro() {
        ...
        System.out.println("\n" + detectiveName + " 탐정님 어서 오십시오. 피로그래밍 22기의 해커톤을 즐겨주시기 바랍니다.\n");
        timer.sleep(1500);

        // 5. 캐릭터 중 한 명을 희생자로 지정하고, 목록에서 제거
        victim = characters.get(random.nextInt(characters.size()));
        ...
        private void generateDyingMessage() {
            AttributeType type = AttributeType.getRandomType();
            dyingMessage = switch (type) {
    ...
    public void investigate() {
        ...
        for (Character character : characters) {
            if (character.getName().equals(choiceName)) {
                System.out.println("\n" + character.getName() + "의 인상착의를 봅니다.");
                System.out.println("- 머리: " + character.getHair());
                System.out.println("- 옷: " + character.getClothes());
                System.out.println("- 신발: " + character.getShoes());
                return;
            }
        }
    ...
    public void accuse() {
        ...
        // 10. characters 각 항목을 인덱스와 함께 출력
